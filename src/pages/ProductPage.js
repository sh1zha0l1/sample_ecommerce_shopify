...
const ProductPage = () => {
  ...
  return (
    <>
      <Box p="2rem">
        <Grid templateColumns={['repeat(1, 1fr)', 'repeat(2, 1fr)']} m="auto">
          ...
          <Box px="2rem" display="flex" flexDir="column" alignItems="center" justifyContent="center">
            ...
            <Button w="10rem" backgroundColor="#6d5e4c" color="white" _hover={{ opacity: '70%' }}
      ...
      <RichText heading="Rated the best product of 2021!" />
      <Center fontWeight="bold" >You Might also like</Center>
